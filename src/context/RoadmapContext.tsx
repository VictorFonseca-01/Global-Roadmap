...
export function RoadmapProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    // Only load if year changes, we use setTimeout to make it asynchronous
    // to avoid triggering cascading renders during the same event loop if React gets sensitive
    const loadData = () => {
