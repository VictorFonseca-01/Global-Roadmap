...
export function RoadmapProvider({ children }: { children: ReactNode }) {
  ...
  if (year !== prevYear) {
    ...
    const savedItems = localStorage.getItem(`roadmap_data_${year}`);
    setItems(savedItems ? JSON.parse(savedItems) : (year === new Date().getFullYear() ? DEFAULT_ITEMS : []));
  }
