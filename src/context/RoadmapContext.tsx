...
export function RoadmapProvider({ children }: { children: ReactNode }) {
  ...
  const [swimlanes, setSwimlanes] = useState<Swimlane[]>(() => {
    try {
      ...
      console.error('Error parsing swimlanes from localStorage', e);
    }
  ...
  // Keep local storage synced with state on year change, avoid setting state directly in effect
  const handleYearChange = (newYear: number) => {
    ...
    try {
      ...
      console.error('Error parsing roadmap data on year change', e);
    }
  };
