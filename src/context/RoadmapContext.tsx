...
export function RoadmapProvider({ children }: { children: ReactNode }) {
  ...
  // Em vez de usar useEffect, podemos simplesmente inicializar o estado corretamente ou ajustar via evento de mudança do ano
  // Porém para simplificar a correção de erro sem alterar a estrutura drástica,
  // vamos extrair para uma função chamada via um handler externo (como o setYear).
